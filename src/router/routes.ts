...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      {
        path: 'patient-mini-program/:screen?',
        name: 'patient-mini-program',
        component: () => import('pages/PatientMiniProgramPreviewPage.vue'),
      },
      // 支付结果页 - 公开路由，不需要认证
      {
        path: 'payment/result',
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('pages/PatientInsightsPage.vue'),
        props: true,
      },
      {
        path: 'follow-ups',
