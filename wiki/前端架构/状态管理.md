...
```mermaid
flowchart TB
LoginPage["LoginPage.vue"] --> authStore["authStore"]
UploadPage["UploadPage.vue"] --> studyStore["studyStore"]
UploadPage --> analysisStore["analysisStore"]
MainLayout["MainLayout.vue"] --> authStore
authStore --> apiService["apiService.ts"]
studyStore --> apiService
analysisStore --> apiService
modelStore["modelStore"] --> apiService
apiService --> api["api.ts"]
```
