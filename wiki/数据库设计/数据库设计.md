...
- `email`: VARCHAR(100), 唯一，可为空，格式验证
- `password_hash`: VARCHAR(255), 非空，bcrypt加密存储
- `real_name`: VARCHAR(100), 可为空
- `phone`: VARCHAR(20), 可为空
- `hospital_id`: VARCHAR(50), 可为空，所属医院ID
- `employee_id`: VARCHAR(50), 唯一，可为空，工号
...
- 管理员账号由初始化脚本创建
- `hospital_id` 关联前端常量配置 `src/constants/hospitals.ts`
...
- `birth_date`: DATE, 可为空
- `phone`: VARCHAR(20), 可为空
- `sexual_history`: ENUM('none','regular','irregular','multiple_partners','early_sexual_activity','other'), 性生活史，默认'none'
- `id_card`: VARCHAR(50), 身份证号（加密存储）
- `medical_card_no`: VARCHAR(50), 医保卡号
- `address`: VARCHAR(500), 可为空
- `emergency_contact`: VARCHAR(100), 紧急联系人
- `emergency_phone`: VARCHAR(20), 紧急联系电话
- `emergency_relation`: VARCHAR(50), 紧急联系人关系
...
- [Patient.js](file://server/models/Patient.js#L5-L69)
- [Study.js](file://server/models/Study.js#L5-L75)
- [StudyImage.js](file://server/models/StudyImage.js#L5-L104)
- [AnalysisTask.js](file://server/models/AnalysisTask.js#L5-L109)
- [AnalysisResult.js](file://server/models/AnalysisResult.js#L5-L127)
- [MedicalReport.js](file://server/models/MedicalReport.js#L5-L170)
- [SmsCode.js](file://server/models/SmsCode.js#L5-L50)
...
- [models/index.js](file://server/models/index.js#L1-L104)
