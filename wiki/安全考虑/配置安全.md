...
- **`DB_PASSWORD`**: 数据库密码，当前为 `xingran8`。
...
- **阿里云短信服务 (Aliyun SMS)**:
  - `ALIYUN_ACCESS_KEY_ID`: 访问密钥 ID，当前为 `LTAI5tLyMFsuzE9hpGijaz9K`。
  - `ALIYUN_ACCESS_KEY_SECRET`: 访问密钥密钥，当前为 `XqnPIZ36pux2MPLqxHqaG7NY5lJlIt`。
- **通义千问大模型 (Qwen AI)**:
  - `QWEN_API_KEY`: 大模型 API 密钥，当前为 `sk-f3d24edd4a184ea28455213df267693a`。
